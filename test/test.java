...
public class test {
        @Test {
                ...
                Room room3 = new Room("Room 3", null, null, null, room2, null, null);
                room3.setDescription("This is the third room.");
                room1.setStory("And then!");

                Room room4 = new Room("Room 4", null, room2, null, null, null, null);
                room4.setDescription("This is the fourth room.");
                room1.setStory("And then!");

                Room room5 = new Room("Room 5", room2, null, null, null, null, null);
                room5.setDescription("This is the fifth room.");
                room1.setStory("And then!");

                Room room6 = new Room("Room 6", null, null, null, room2, null, null);
